...
function Admin() {
  ...
  async function fetch_all_questions () {
    const url='http://192.168.0.104:8000/admin/questions'
    ...
    return (
      <>
          ...
          (<>
            ...
            <div className="get_all_questions flex my-5 flex-col container mx-auto w-[100vw]">
                                ...
                                <div className="overflow-hidden rounded">
                                  <table className="min-w-full bg-white">
                                    <thead className="border">
                                      <tr>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left w-[5vw]">Question No.</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Question</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Option A</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Option B</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Option C</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Option D</th>
                                        <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Answer</th>
                                      </tr>
                                    </thead>
                                    <tbody>
